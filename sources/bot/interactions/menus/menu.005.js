...
const interaction = {
    ...
    async exec(interaction, message) {
        ...
        if (seleccionador === '001') {
            modal.setCustomId('modal.008')
                .setTitle('Tipo de mensaje de despedida');
            let selector = new discord.StringSelectMenuBuilder()
                .setCustomId('menu.005.001')
        ...
        if (seleccionador === '002') {
            modal.setCustomId('modal.009')
                .setTitle('Canal de despedidas');
            let selector = new discord.ChannelSelectMenuBuilder()
                .setCustomId('menu.005.002')
        ...
        if (seleccionador === '003') {
            modal.setCustomId('modal.010')
                .setTitle('Titulo del mensaje de despedida');
            let title = new discord.LabelBuilder()
                .setLabel('Titulo a mostrar')
                .setTextInputComponent(new discord.TextInputBuilder()
                .setCustomId('menu.005.003.title')
                .setPlaceholder('Titulo del mensaje de despedida')
        ...
        if (seleccionador === '004') {
            modal.setCustomId('modal.011')
                .setTitle('Descripción del mensaje de despedida');
            let description = new discord.LabelBuilder()
                .setLabel('Descripción a mostrar')
                .setTextInputComponent(new discord.TextInputBuilder()
                .setCustomId('menu.005.004.description')
                .setPlaceholder('Descripción del mensaje de despedida')
                .setMaxLength(60)
                .setStyle(discord.TextInputStyle.Short)
                .setRequired(true));
        ...
        if (seleccionador === '005') {
            modal.setCustomId('modal.012')
                .setTitle('Mensaje de despedida');
            let message = new discord.LabelBuilder()
                .setLabel('Mensaje a mostrar')
                .setTextInputComponent(new discord.TextInputBuilder()
                .setCustomId('menu.005.005.message')
                .setPlaceholder('Mensaje de despedida')
                .setMaxLength(400)
        ...
        if (seleccionador === '006') {
            ...
            let value = new discord.LabelBuilder()
                ...
                .setTextInputComponent(new discord.TextInputBuilder()
                .setCustomId('menu.005.006.value')
        ...
        if (seleccionador === '007') {
            modal.setCustomId('modal.014')
                .setTitle('Colores del mensaje de despedida');
            ...
            let descriptionLabel = new discord.LabelBuilder()
                ...
                .setDescription('esto solo aplica si el mensaje es una imagen')
                .setTextInputComponent(new discord.TextInputBuilder()
                .setCustomId('menu.005.007.background')
            ...
            let borderImageColorLabel = new discord.LabelBuilder()
                ...
                .setDescription('esto solo aplica si el mensaje es una imagen')
                .setTextInputComponent(new discord.TextInputBuilder()
                .setCustomId('menu.005.007.border')
                .setPlaceholder('#1a1d1f')
                .setStyle(discord.TextInputStyle.Short)
                .setRequired(false));
